...
public class Constants {
    public static final String[] facultyList = new String[]{"", "công nghệ thông tin", "điện tử viễn thông", "điện điện tử", "quản trị kinh doanh", "kế toán"};
    ...
    public static final String[] answerText = new String[]{"A", "B", "C", "D"};
    public static final String[] studentProperties = new String[]{"fir", "B", "C", "D"};
