...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$()
    {
        ...
        btnSearch.setText("");
        panel2.add(btnSearch, new GridConstraints(0, 6, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        panel3.add(panel4, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, new Dimension(300, 500), new Dimension(300, 500), new Dimension(300, 500), 0, false));
        ...
        panel5.add(panel6, new GridConstraints(0, 0, 1, 5, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        ...
        panel5.add(scrollPane1, new GridConstraints(2, 1, 1, 5, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_WANT_GROW, null, null, null, 0, false));
        txtContentAnswer1 = new JTextArea();
        txtContentAnswer1.setEditable(false);
        txtContentAnswer1.setMaximumSize(new Dimension(450, 20));
        txtContentAnswer1.setMinimumSize(new Dimension(450, 20));
        txtContentAnswer1.setPreferredSize(new Dimension(450, 20));
        txtContentAnswer1.setText("");
        scrollPane1.setViewportView(txtContentAnswer1);
        final JLabel label4 = new JLabel();
        label4.setText("A.");
        panel5.add(label4, new GridConstraints(2, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(23, 14), null, 0, false));
        final JScrollPane scrollPane2 = new JScrollPane();
        panel5.add(scrollPane2, new GridConstraints(3, 1, 1, 5, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_WANT_GROW, null, null, null, 0, false));
        txtContentAnswer2 = new JTextArea();
        txtContentAnswer2.setEditable(false);
        txtContentAnswer2.setEnabled(true);
        txtContentAnswer2.setMaximumSize(new Dimension(450, 20));
        txtContentAnswer2.setMinimumSize(new Dimension(450, 20));
        txtContentAnswer2.setPreferredSize(new Dimension(450, 20));
        scrollPane2.setViewportView(txtContentAnswer2);
        final JScrollPane scrollPane3 = new JScrollPane();
        panel5.add(scrollPane3, new GridConstraints(4, 1, 1, 5, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_WANT_GROW, null, null, null, 0, false));
        txtContentAnswer3 = new JTextArea();
        txtContentAnswer3.setEditable(false);
        txtContentAnswer3.setMaximumSize(new Dimension(450, 20));
        txtContentAnswer3.setMinimumSize(new Dimension(450, 20));
        txtContentAnswer3.setPreferredSize(new Dimension(450, 20));
        scrollPane3.setViewportView(txtContentAnswer3);
        final JScrollPane scrollPane4 = new JScrollPane();
        panel5.add(scrollPane4, new GridConstraints(5, 1, 1, 5, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_WANT_GROW, null, null, null, 0, false));
        txtContentAnswer4 = new JTextArea();
        txtContentAnswer4.setEditable(false);
        txtContentAnswer4.setMaximumSize(new Dimension(450, 20));
        txtContentAnswer4.setMinimumSize(new Dimension(450, 20));
        txtContentAnswer4.setPreferredSize(new Dimension(450, 20));
        txtContentAnswer4.setText("");
        scrollPane4.setViewportView(txtContentAnswer4);
        final JLabel label5 = new JLabel();
        label5.setText("B.");
        panel5.add(label5, new GridConstraints(3, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(23, 14), null, 0, false));
        final JLabel label6 = new JLabel();
        label6.setText("C.");
        panel5.add(label6, new GridConstraints(4, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(23, 14), null, 0, false));
        final JLabel label7 = new JLabel();
        label7.setText("D.");
        panel5.add(label7, new GridConstraints(5, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(23, 14), null, 0, false));
        final JScrollPane scrollPane5 = new JScrollPane();
        panel5.add(scrollPane5, new GridConstraints(1, 0, 1, 4, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        txtContentQuestion = new JTextArea();
        txtContentQuestion.setEditable(false);
        txtContentQuestion.setMaximumSize(new Dimension(300, 150));
        txtContentQuestion.setMinimumSize(new Dimension(300, 150));
        txtContentQuestion.setPreferredSize(new Dimension(300, 150));
        txtContentQuestion.setText("");
        scrollPane5.setViewportView(txtContentQuestion);
        lbImage = new JLabel();
        lbImage.setIcon(new ImageIcon(getClass().getResource("/images/no_image.png")));
        lbImage.setText("");
        panel5.add(lbImage, new GridConstraints(1, 4, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, new Dimension(150, 150), new Dimension(150, 150), new Dimension(150, 150), 0, false));
